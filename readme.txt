...
Installing "PCGame client" can be done either by searching for "PCGame client" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
